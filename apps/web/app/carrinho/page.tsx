    ...
    <main className="mx-auto max-w-5xl p-4">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-[2fr_1fr]">
            ...
            >
              ...
              <div className="flex min-w-0 flex-1 items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    aria-label="Remover"
                    className="rounded-md border border-neutral-800 p-2 text-neutral-300 hover:bg-neutral-900/60"
                  >
                    <Trash2 size={16} />
                  </button>
                </div>
        ...
        <aside className="h-fit space-y-3 rounded-lg border border-neutral-800 p-4">
          ...
          <Link
            href="/"
            className="block text-center text-xs text-neutral-400 hover:text-neutral-100"
          >
            Continuar comprando
          </Link>
        </aside>
